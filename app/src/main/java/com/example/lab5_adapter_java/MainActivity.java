package com.example.lab5_adapter_java;
...
public class MainActivity extends AppCompatActivity {
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        private int veiw;
        public MyAdapter (MainActivity.Data[] data , int veiw){
            this.data = data;
            this.veiw = veiw;
        }
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        int [] transPhotoArray = new  int[]{R.drawable.trans1,R.drawable.trans2,R.drawable.trans3,R.drawable.trans4};
